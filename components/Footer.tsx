...
import { NAV_LINKS, CONTACT_INFO, SOCIAL_LINKS, BRAND_PROMISE } from "@/lib/constants";

export function Footer() {
  return (
    <footer className="bg-primary text-secondary">
      <div className="mx-auto grid max-w-content gap-10 px-6 py-16 md:grid-cols-[1.3fr_1fr_1fr]">
        <div>
          <Logo theme="on-green" />
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2.5 font-sans text-sm text-secondary/85">
            <li>Tel / WhatsApp: {CONTACT_INFO.phone}</li>
